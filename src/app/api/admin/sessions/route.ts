...
export async function GET(request: NextRequest) {
  ...
  const selectFields =
    "id, platform_chat_id, agent_id, channel_id, version, is_active, updated_at, messages, metadata, active_skill_ids, agents(name), channels:channel_id(platform, display_name)";
